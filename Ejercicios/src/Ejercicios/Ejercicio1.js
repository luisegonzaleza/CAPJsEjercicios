...

{
    ...
    // * En caso de no encontrar corridas, regresar un error con el mensaje "No hay corridas disponibles"
        ...
        function busquedaCorridaWeb(descripcion, empresa = "AEF"){
            let array = [];
            let valida = corridasWeb.filter(corrida => corrida.empresa === empresa && corrida.descripcionServicio === descripcion);
            if(!(valida.length == 0)){
                valida.forEach(corrida => {
                    array.push({"numCorrida":corrida.numeroCorrida,"descripcionServicio":corrida.descripcionServicio, "empresa":corrida.empresa, "descripcionEmpresa":corrida.descripcionEmpresa,"listaDescuentos": corrida.listaDescuentos === undefined ? false : true});
                });
            } else{
        ...
        console.log(busquedaCorridaWeb("PRIMERA SELECT", "TCH"));
        // console.log(busquedaCorridaWeb("No existente"));
}